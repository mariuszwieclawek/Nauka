...
{	
	...
	ADC0->SC1[0] |= ADC_SC1_ADCH(0);		// Wyzwolenie programowe przetwornika ADC0 w kanale 0
}
int main (void)
{
	uint8_t	kal_error;
	...
	//pr ADC0->SC1[0] = ADC_SC1_AIEN_MASK | ADC_SC1_ADCH(12);		// Pierwsze wyzwolenie przetwornika ADC0 w kanale 12 i odblokowanie przerwania
