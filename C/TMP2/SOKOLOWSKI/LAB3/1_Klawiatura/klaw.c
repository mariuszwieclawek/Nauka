...
void Klaw_S2_4_Int(void)
{
	...
	NVIC_ClearPendingIRQ(PORTA_IRQn); //funkcja kasująca ewentualne, niechciane (nieprzewidziane) przerwanie o numerze (nazwie) „IRQn”
	NVIC_EnableIRQ(PORTA_IRQn); //odblokowanie przerwania o numerze (nazwie) „IRQn”
}
